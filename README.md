...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=JetBrains+Mono&size=16&pause=1200&color=4A9EDB&center=true&vCenter=true&width=480&lines=Embedded+Systems+%7C+Bare-Metal+Firmware;Analog+Design+%7C+FPGA+%7C+Robotics;3rd+Year+EE+%E2%80%94+Building+real+hardware)](https://git.io/typing-svg)
</div>
...
| Project | Stack |
|---------|-------|
| [Autonomous Obstacle-Avoiding Robot](https://github.com/Samra761/Obstacle-avoiding-robot-avr) | Pure C · AVR-GCC · ATmega328P · HC-SR04 |
| [CyberShooter — Real-Time 2D Game](https://github.com/Samra761/Cyber-Shooter-Game-Python-DSA) | Python · Pygame · Custom DSA |
